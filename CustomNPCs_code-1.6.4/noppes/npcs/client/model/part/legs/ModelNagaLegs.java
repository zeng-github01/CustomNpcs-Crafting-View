...
public class ModelNagaLegs extends ModelRenderer {
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
      ...
      if (this.isSleeping || this.isCrawling) {
         this.nagaPart3.field_78795_f = (-(float)Math.PI / 2F);
         this.nagaPart4.field_78795_f = (-(float)Math.PI / 2F);
         this.nagaPart5.field_78795_f = (-(float)Math.PI / 2F);
         ModelRenderer var10000 = this.nagaPart3;
      ...
      if (this.isRiding) {
         ...
         ModelRenderer var10 = this.nagaPart2;
         var10.field_78797_d -= 4.0F;
         this.nagaPart2.field_78798_e = -1.0F;
         var10 = this.nagaPart3;
         var10.field_78797_d -= 9.0F;
         --this.nagaPart3.field_78798_e;
         var10 = this.nagaPart4;
         var10.field_78797_d -= 13.0F;
         --this.nagaPart4.field_78798_e;
         var10 = this.nagaPart5;
         var10.field_78797_d -= 9.0F;
         --this.nagaPart5.field_78798_e;
         if (this.isSneaking) {
            var10 = this.nagaPart1;
            var10.field_78798_e += 5.0F;
            var10 = this.nagaPart3;
            var10.field_78798_e += 5.0F;
            var10 = this.nagaPart4;
            var10.field_78798_e += 5.0F;
            var10 = this.nagaPart5;
            var10.field_78798_e += 4.0F;
            --this.nagaPart1.field_78797_d;
