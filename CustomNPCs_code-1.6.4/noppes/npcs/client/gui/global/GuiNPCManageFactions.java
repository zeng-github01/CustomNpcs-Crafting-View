...
public class GuiNPCManageFactions extends GuiNPCInterface2 implements IScrollData, GuiCustomScrollActionListener, ITextfieldListener, IGuiData {
   ...
   public void func_73866_w_() {
      ...
      if (this.faction.id != -1) {
         ...
         this.addLabel(new GuiNpcLabel(0, "gui.name", this.guiLeft + 8, this.guiTop + 9, 4210752));

         String color;
         for(color = Integer.toHexString(this.faction.color); color.length() < 6; color = "0" + color) {
         }

         this.addTextField(new GuiNpcTextField(1, this, this.field_73886_k, this.guiLeft + 48, this.guiTop + 26, 165, 20, color));
         this.addLabel(new GuiNpcLabel(1, "gui.color", this.guiLeft + 8, this.guiTop + 31, 4210752));
         this.getTextField(1).func_73804_f(6);
         this.getTextField(1).func_73794_g(this.faction.color);
         this.addLabel(new GuiNpcLabel(2, "faction.points", this.guiLeft + 8, this.guiTop + 53, 4210752));
         this.addButton(new GuiNpcButton(2, this.guiLeft + 80, this.guiTop + 48, 45, 20, "selectServer.edit"));
         this.addLabel(new GuiNpcLabel(3, "faction.hidden", this.guiLeft + 8, this.guiTop + 75, 4210752));
         ...
         this.addLabel(new GuiNpcLabel(4, "faction.attacked", this.guiLeft + 8, this.guiTop + 97, 4210752));
         ...
         this.addLabel(new GuiNpcLabel(6, "faction.hostiles", this.guiLeft + 8, this.guiTop + 145, 4210752));
   ...
   protected void func_73875_a(GuiButton guibutton) {
      ...
      if (guibutton.field_73741_f == 1 && this.data.containsKey(this.scrollFactions.getSelected())) {
   ...
   public void unFocused(GuiNpcTextField guiNpcTextField) {
      if (this.faction.id != -1) {
         if (guiNpcTextField.id == 0) {
            ...
            try {
               color = Integer.parseInt(guiNpcTextField.func_73781_b(), 16);
