...
public class Bank {
   ...
   public void writeEntityToNBT(NBTTagCompound nbttagcompound) {
      ...
      nbttagcompound.func_74766_a("BankCurrency", this.currencyInventory.getToNBT());
      nbttagcompound.func_74766_a("BankUpgrade", this.upgradeInventory.getToNBT());
   ...
   public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
      ...
      this.slotTypes = NBTTags.getIntegerIntegerMap(nbttagcompound.func_74761_m("BankTypes"));
